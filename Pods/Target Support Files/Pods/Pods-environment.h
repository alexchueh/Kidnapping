...
// PIXToolbar
#define COCOAPODS_POD_AVAILABLE_PIXToolbar
#define COCOAPODS_VERSION_MAJOR_PIXToolbar 1
#define COCOAPODS_VERSION_MINOR_PIXToolbar 0
#define COCOAPODS_VERSION_PATCH_PIXToolbar 2
